        ...
        jQuery(document).ready(function () {
            ...
            $("#btn-add-item").click(function (ev) {
                $.get("${createLink(action: 'addItem', id: crmInvoice.id)}", function (markup) {
                    ...
                    $(":input:visible:enabled:first", html).focus();
                });
            });
        });
    </script>
            ...
            <div class="tab-pane active" id="main">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <g:textField name="customerEmail" value="${crmInvoice.customerEmail}"
                                                 class="span12"/>
                                </div>
                            </div>
                    ...
                    <div class="span3">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <g:select name="paymentTerm.id" from="${metadata.paymentTermList}"
                                          value="${crmInvoice.paymentTermId}"
                                          optionKey="id" class="span12"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">
                                <g:message code="crmInvoice.paymentStatus.label"/>
                            </label>

                            <div class="controls">
                                <g:select name="paymentStatus" from="${metadata.paymentStatusList}"
                                          value="${crmInvoice.paymentStatus}"
                                          valueMessagePrefix="crmInvoice.paymentStatus" class="span12"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label">
                                <g:message code="crmInvoice.paymentDate.label"/>
                            </label>

                            <div class="controls">
                                <div class="inline input-append date"
                                     data-date="${formatDate(type: 'date', date: crmInvoice.paymentDate ?: new Date())}">
                                    <g:textField name="paymentDate" class="span10" size="10"
                                                 value="${formatDate(type: 'date', date: crmInvoice.paymentDate)}"/><span
                                        class="add-on"><i
                                            class="icon-th"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">
                                <g:message code="crmInvoice.payedAmount.label"/>
                            </label>

                            <div class="controls">
                                <g:textField name="payedAmount"
                                             value="${formatNumber(number: crmInvoice.payedAmount, minFractionDigits: 2)}"
                                             class="span12"/>
                            </div>
                        </div>
                ...
                <div class="form-actions">
                    <crm:button action="edit" visual="warning" icon="icon-ok icon-white"
                                label="crmInvoice.button.save.label"/>
